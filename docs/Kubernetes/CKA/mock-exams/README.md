...
- Complete [GRADING.md](https://github.com/theplatformlab/CKA-Certified-Kubernetes-Administrator/blob/main/GRADING.md) self-assessment
...
These are practice scenarios inspired by real CKA exam domains and topics. They are independently written training materials designed to help you prepare. They are NOT actual CKA exam questions. The Linux Foundation does not share real exam questions publicly. For more information, see [CONTRIBUTING.md](https://github.com/theplatformlab/CKA-Certified-Kubernetes-Administrator/blob/main/CONTRIBUTING.md) and [CODE_OF_CONDUCT.md](https://github.com/theplatformlab/CKA-Certified-Kubernetes-Administrator/blob/main/CODE_OF_CONDUCT.md).

---

## Study Resources

- 📖 **Exercise Theory:** See [DOMAINS.md](https://github.com/theplatformlab/CKA-Certified-Kubernetes-Administrator/blob/main/DOMAINS.md) for domain-to-exercise mapping
- 📝 **Self-Grading:** Use [GRADING.md](https://github.com/theplatformlab/CKA-Certified-Kubernetes-Administrator/blob/main/GRADING.md) to score individual exercises
- 🔧 **Reference Solutions:** each exercise's own solution is in its [Day1–Day31 page](../exercises/Day1.md)
