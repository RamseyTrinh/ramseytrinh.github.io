...
> Related: [RBAC skeleton](../skeletons/rbac.md) | [ClusterRole skeleton](../skeletons/clusterrole.md) | Domain: Cluster Architecture, Installation & Configuration (25%)
...
??? note "Stuck? Click to reveal hints"
